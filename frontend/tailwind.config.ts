  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        genome: {
          pink: "hsl(var(--genome-pink))",
          "pink-glow": "hsl(var(--genome-pink-glow))",
          dark: "hsl(var(--genome-dark))",
          darker: "hsl(var(--genome-darker))",
          card: "hsl(var(--genome-card))",
          border: "hsl(var(--genome-border))",
        },
        skill: {
      ...
      backgroundImage: {
        ...
        "genome-gradient": "linear-gradient(135deg, hsl(var(--genome-dark)) 0%, hsl(var(--genome-darker)) 100%)",
        "pink-gradient": "linear-gradient(135deg, hsl(var(--genome-pink)) 0%, hsl(var(--genome-pink-glow)) 100%)",
      },
    },
  },
